      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight"> Girish Kumar</h1>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 text-sm text-muted-foreground">
            <div className="flex items-center gap-1">
              ...
              <a href="mailto:shivanshagrawal3007@gmail.com">gmaheshwari799@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <Link
              href="https://drive.google.com/file/d/1UtG5H3TjxzIgVx4WG7bBzI6_XGSREAJm/view?usp=sharing"
              target="_blank"
              download
            >
            ...
            <Link
              href="https://github.com/Girish2005-gm"
              target="_blank"
            >
            ...
            <Link
              href="mailto:gmaheshwari799@gmail.com"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
            ...
            <Link
              href="https://www.linkedin.com/in/girish-maheshwari-10402925a/"
              target="_blank"
            >
              <Button variant="outline" size="sm" className="text-xs sm:text-sm">
